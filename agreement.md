...
**我不开心**应用根据以下服务条款为您提供服务。这些条款可由我不开心随时更新，且毋须另行通知。使用协议一旦发生变动，将在网页上公布修改内容。修改后的使用协议一旦在网页上公布即有效代替原来的使用协议。此外，当您使用我不开心特殊服务时，您和我不开心应遵守我不开心随时公布的与该服务相关的指引和规则。前述所有的指引和规则，均构成本使用协议的一部分。
您在使用我不开心提供的各项服务之前，应仔细阅读本使用协议。如您不同意本使用协议及/或随时对其的修改，请您立即停止使用我不开心所提供的全部服务；您一旦使用我不开心服务，即视为您已了解并完全同意本使用协议各项内容，包括我不开心对使用协议随时所做的任何修改，并成为我不开心用户（以下简称“用户”）。

### 2、遵守法律

您同意遵守中华人民共和国相关法律法规的所有规定，并对以任何方式使用您的密码和您的帐号使用本服务的任何行为及其结果承担全部责任。如您的行为违反国家法律和法规的任何规定，有可能构成犯罪的，将被追究刑事责任，并由您承担全部法律责任。
同时如果我不开心有理由认为您的任何行为，包括但不限于您的任何言论和其它行为违反或可能违反国家法律和法规的任何规定，我不开心可在任何时候不经任何事先通知终止向您提供服务。

### 3、您的注册义务

1. 为了能使用本服务，您需要注册我不开心帐号应当使用手机号码绑定注册，请用户使用尚未与“我不开心”帐号绑定的手机号码，以及未被我不开心公司封禁的手机号码注册“我不开心”帐号。我不开心公司可以根据用户需求或产品需要对帐号注册和绑定的方式进行变更，而无须事先通知用户。
2. “我不开心”系基于地理位置的移动社交产品，用户注册时应当授权我不开心科技公开及使用其地理位置信息方可成功注册“我不开心”帐号。故用户完成注册即表明用户同意我不开心公司提取、公开及使用用户的地理位置信息。如用户需要终止向其他用户公开其地理位置信息，可自行设置为不显示状态地址。
3. 鉴于我不开心帐号的注册方式，您同意我不开心公司在注册时将使用您提供的手机号码及/或自动提取您的手机号码及自动提取您的手机设备识别码等信息用于注册。
4. 在用户注册及使用本服务时，我不开心科技需要搜集能识别用户身份的个人信息以便我不开心科技可以在必要时联系用户，或为用户提供更好的使用体验。我不开心科技搜集的信息包括但不限于用户的姓名、性别、年龄、出生日期、身份证号、地址、学校情况、公司情况、所属行业、兴趣爱好、常出没的地方、个人说明；我不开心科技同意对这些信息的使用将受限于第三条用户个人隐私信息保护的约束。
5. 您需要确保今后更新的手机号码、名号、头像等资料，和在我不开心上发布的所有内容的有效性和合法性。若您提供任何违法、不道德或我不开心认为不适合在我不开心上展示的资料；或者我不开心有理由怀疑你的资料属于程序或恶意操作，我不开心有权暂停或终止您的帐号，并拒绝您于现在和未来使用本服务之全部或任何部分。 我不开心无须对任何用户的任何登记资料承担任何责任，包括但不限于鉴别、核实任何登记资料的真实性、正确性、完整性、适用性及/或是否为最新资料的责任。
6. 根据有关法律法规，我不开心在此郑重提请您注意，任何经由本服务而发布、上传的文字、照片、或其它资料（以下简称“内容 ”），无论系公开还是私下传送，均由内容提供者承担责任。我不开心仅为用户提供内容存储空间，无法控制经由本服务传送之内容，因此不保证内容的正确性、完整性或品质。您已预知使用本服务时，可能会接触到令人不快、不适当或令人厌恶之内容。在任何情况下，我不开心均不为任何内容负责，但我不开心有权依法停止传输任何前述内容并采取相应行动，包括但不限于暂停用户使用本服务的全部或部分，保存有关记录，并向有关机关报告。

### 4、用户帐号、密码及安全

完成本服务的注册程序并成功注册之后，您可使用您的手机号码、Email和密码，登录到您在我不开心的帐号（下称“帐号”）。保护您的帐号安全，是您的责任。
您应对所有使用您的密码及帐号的活动负完全的责任。您同意

1. 您的我不开心帐号遭到未获授权的使用，或者发生其它任何安全问题时，
2. 如果您未保管好自己的帐号和密码，因此而产生的任何损失或损害，我不开心无法也不承担任何责任；
3. 每个用户都要对其帐号中的所有行为和事件负全责。如果您未保管好自己的帐号和密码而对您、我不开心或第三方造成的损害，您将负全部责任。

### 5、供成员用于非商业用途我不开心服务仅供成员个人使用

您对我不开心所提供的服务的使用不得用于任何商业用途，但经我不开心明确认可或批准的商业使用除外。禁止非法和/或未经授权使用我不开心 服务，包括通过电子或其他方式收集成员的用户名和/或电子邮件地址以便发送垃圾邮件、未经授权建构或链接到 我不开心 网站。我们可以在不经任何通知的情况下删除成员档案文件中的商业广告、关联链接和其他形式的推销内容，并且可以因此而终止您的成员资格。对于任何非法或未 经授权使用我不开心 服务的行为，我们将会采取适当的法律行动。
...
2. 个人隐私信息是指涉及用户个人身份或个人隐私的信息，比如，用户真实姓名、身份证号、手机号码、手机设备识别码、IP地址、用户聊天记录。非个人隐私信息是指用户对本服务的操作状态以及使用习惯等明确且客观反映在我不开心科技服务器端的基本记录信息、个人隐私信息范围外的其它普通信息，以及用户同意公开的上述隐私信息。
3. 我不开心科技将采取技术措施和其他必要措施，确保用户个人隐私信息安全，防止在本服务中收集的用户个人隐私信息泄露、毁损或丢失。在发生前述情形或者我不开心科技发现存在发生前述情形的可能时，将及时采取补救措施。
4. 我不开心科技未经用户同意不向任何第三方公开、 透露用户个人隐私信息。但以下特定情形除外：
   - 我不开心科技根据法律法规规定或有权机关的指示提供用户的个人隐私信息；
   - 由于用户将其用户密码告知他人或与他人共享注册帐户与密码，由此导致的任何个人信息的泄漏，或其他非因我不开心科技原因导致的个人隐私信息的泄露；
   - 用户自行向第三方公开其个人隐私信息；
   - 用户与我不开心科技及合作单位之间就用户个人隐私信息的使用公开达成约定，我不开心科技因此向合作单位公开用户个人隐私信息；
   - 任何由于黑客攻击、电脑病毒侵入及其他不可抗力事件导致用户个人隐私信息的泄露。
5. 用户同意我不开心科技可在以下事项中使用用户的个人隐私信息：
   - 我不开心科技向用户及时发送重要通知，如软件更新、本协议条款的变更；
   - 我不开心科技内部进行审计、数据分析和研究等，以改进我不开心科技的产品、服务和与用户之间的沟通；
   - 依本协议约定，我不开心科技管理、审查用户信息及进行处理措施；
   - 适用法律法规规定的其他事项。
